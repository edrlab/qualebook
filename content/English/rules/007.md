...
abstract: "
Structured appendices such as glossaries, lexicons, bibliographies or indexes are important and essential tools in the printed version of a reference or learning work. Identifying and accessing them quickly in digital versions is just as crucial. This rule ensures that they are clearly marked up and integrated as distinct navigational cues, including via EPUB 3 features (such as `epub:type` and ARIA DPub roles), allowing easy consultation and better understanding of the content for all readers, including those using assistive technologies."
categories:
  - "structure and code"
agrege: O4007-E007
opquast: '4 007'
