...
abstract: "Les métadonnées d’accessibilité permettent d'évaluer si un livre numérique répond aux besoins spécifiques du lectorat avant de l'acheter. Dans certaines conditions particulières, les métadonnées d'accessibilité peuvent ne pas représenter complètement les efforts investis ou les limites possibles. Dans ce cas, un champ spécifique permet d'écrire directement un court texte décrivant ce qui n'est pas représenté par d'autres métadonnées."
categories:
- "identification"
agrege: E014
opquast: N/A
