...
Controle:
  - "Identify the pages containing dates, and for each of the dates found: <ul><li>check that the month is not written in a numerical format, but in letters (full or abbreviated);</li><li>check that the year is indicated in four digits and not two.</li></ul>"
epubcheck:
ace:
humancheck: true
ReadiumGoToolkit:
