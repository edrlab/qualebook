...
Controle:
  - "Please check the arguments of the images that do not convey information necessary for understanding. Cela peut s'effectuer dans le code ou grâce au tableau d'images disponibles dans le rapport ACE"
epubcheck: false
ace: true
humancheck: true
ReadiumGoToolkit:
