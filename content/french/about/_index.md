...
# Une liste de contrôle qualité pour les livre numériques
...
• Ouvrir un ticket sur l'outil de suivi (nécessite un compte GitHub)
• Envoyez-nous un e-mail

## Sous quelle licence le contenu de ce site est-il sous licence ?
• Les règles sont sous licence Creative Commons BY-SA. Vous pouvez les utiliser librement, à condition de conserver l'attribution aux auteurs, par exemple via un lien vers :
