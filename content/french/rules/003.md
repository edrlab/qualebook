...
Controle: 
    - Dans le code source de chaque page examinée     <ul>    <li>Vérifier la présence de la balise <meta name="description" content="décrire ici le contenu">` ou d'un équivalent à l'aide, par exemple, des outils de développement des navigateurs.</li>    <li>Contrôler que le texte de cette balise décrit effectivement, de façon spécifique ou plus générique, le contenu de la page.</li>    </ul>
epubcheck: 
ace: 
humancheck: true
ReadiumGoToolkit: 
