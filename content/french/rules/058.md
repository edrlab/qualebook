...
Meo: 
    - "Appliquer un balisage HTML structurel (balises `h1`, `h2`, `p`, etc.) et sémantique (`em`, `strong`, etc.) rigoureux afin de garantir l'ordre et le sens du contenu même en l'absence de feuilles de style."
Controle: 
