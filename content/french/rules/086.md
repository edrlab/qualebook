...
tags: 
    ...
    - "Interopérabilité"
objectif: 
    - "Assurer la consultabilité sur des outils de lecture anciens."
Meo: 
...
Controle: 
    ...
    - "Vérifier la présence d'informations CSS pour les éléments HTML5 (par exemple, `article`, `aside`, `details`, `figure`, `figcaption`, `footer`, `header`, `nav`, `section`)."
