...
tags: 
    ...
    - "Lisibilité"
objectif: 
    - "Faciliter l’adaptation du rendu aux supports (mobile, tablette ou autre) et aux besoins du lectorat (agrandissement de la taille des caractères, modification des couleurs, de la police, de la graisse, de la justification, etc.)."
    - "Améliorer l’accessibilité des contenus aux personnes en situation de handicap."
    - "Améliorer la prise en compte des contenus par les moteurs de recherche propres aux outils de lecture."
Meo: 
