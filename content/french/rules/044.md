...
Controle: 
    ...
    - S’il n’existe pas de style spécifique dans le document, s’assurer que le style par défaut du logiciel ou de l’outil de lecture permet tout de même d’identifier clairement les liens visités. 
epubcheck: 
ace: 
humancheck: true
ReadiumGoToolkit: 
