...
abstract: "L'attribution d'un titre aux tableaux de données permet aux lecteurs de comprendre clairement leur contenu avant de naviguer dans les données."
categories: 
    - "structure et code"
agrege: O4237-E076
opquast: '4 237'
...
tags: 
    ...
    - "Lisibilité"
objectif: 
    - "Permettre aux utilisateurs des technologies d'assistance d'identifier aisément la nature des informations fournies par un tableau."
