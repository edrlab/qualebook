...
Meo: 
    - "Pour les  animations visuelles d’une durée supérieure à 5 secondes ou un son d’une durée supérieure à 3 secondes, doter systématiquement l'objet multimédia d'une interface de pilotage standard&nbsp;: démarrage, pause, réglage du volume. Ne pas utiliser de graphismes animés non contrôlables ou partiellement contrôlables par l'utilisateur (images gif animées en particulier). Dans les métadonnées de l’OPF, indiquer ces métadonnées&nbsp;: <meta property=schema:accessibilityHazard>noFlashingHazard</meta> <meta property=schema:accessibilityHazard>noMotionSimulationHazard</meta><meta property=schema:accessibilityHazard>noSoundHazard</meta>"
Controle: 
