...
Meo: 
    ...
    - "Indiquer l’adresse de la page cible ou le rôle du lien dans l’attribut `alt` de l’élément `img`, `objet` ou `canvas`."
Contrôle: 
    - "Vérifier que l’attribut alt de chaque élément `img`, `objet` ou `canvas` concerné indique la cible ou le rôle du lien."
