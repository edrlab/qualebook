...
abstract: "Des images peuvent être dotées d’une adresse internet (URL) dirigeant vers nouvelle page ou en dehors du livre, dans ce cas la destination du lien doit être indiquée. Un cas d’usage courant est un logo de la maison d’édition qui sert de lien vers le site internet. D’autres exemples incluent une image de licence pointant vers la page de la licence, ou un QR code menant vers une ressource en ligne."
categories: 
    - "images et médias"
agrege: O4112-E023
opquast: '4 112'
