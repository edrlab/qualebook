...
abstract: "Les annexes structurées telles que les glossaires, lexiques, bibliographies ou index sont des outils importants et essentiels dans la version imprimée d'un ouvrage de référence ou d'apprentissage. Les identifier et y accéder rapidement dans les versions numériques est tout autant crucial : cela garantit qu'ils soient intégrés comme repères de navigation distincts, notamment via les fonctionnalités EPUB 3 (comme les `epub:type` et les rôles ARIA DPub), permettant une consultation aisée et une meilleure compréhension du contenu pour toutes les personnes, y compris celles utilisant des technologies d'assistance."
categories: 
    - "structure et code"
agrege: O4007-E007
opquast: '4 007'
