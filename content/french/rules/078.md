...
Controle: 
    - "Ouvrez votre EPUB dans plusieurs liseuses différentes, redimensionnez la fenêtre ou changez l'orientation : Le tableau est-il toujours lisible ? Le contenu se déplace-t-il correctement ? Y a-t-il des barres de défilement pour les tableaux larges ?"
